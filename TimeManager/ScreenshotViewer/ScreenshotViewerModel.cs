...
{
    public class ScreenshotViewerModel
    {
        private Screenshot currentScreenshot;
        private ScreenshotViewerView nvv;
        private TimeBlockAdder.TimePeriodAdderModel tpm;
        ...
        public ScreenshotViewerModel (ScreenshotViewerView nvv, TimeBlockAdder.TimePeriodAdderModel tpm, DateTime startTimestamp)
        {
            this.nvv = nvv;
            this.tpm = tpm;
